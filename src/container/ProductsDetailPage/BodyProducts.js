        ...
        <div className="container-page">
          <div className="detailSlider">
            ...
            <div className="viewSelection">
              <div className="viewSelection-phone">
                <img alt="" src={Carousel} />
              </div>
              <div className="viewSelection-pc">
                <img alt="" src={MayTinh} />{' '}
              </div>
            </div>
              ...
              <Slider {...settings}>
                {imageProducts.map((item, index) => {
                  return (
                    <li
                      key={index}
                      onClick={() => onShowImageProducts(item)}
                      className="slider-item"
                    >
                      <div className="slider-image">
                        <img className="" alt="" src={item.imageProduct} />
                      </div>
                    </li>
                  );
                })}
          ...
          <div className="detailContent">
            <div className="hideOnMobile">
              ...
              <div className="blog-feauter">
                <span className="blog-list">
                  A mobile-first body scanning and measuring technology that
                  provides accurate data-driven size and fit recommendations and
                  photorealistic virtual try-on to help optimize processes,
                  reduce returns while boosting sales, and increasing shopping
                  confidence.
                </span>
              </div>
              ...
              <div className="configurableSection">
                <div className="title-wrapper">PLATFORMS AVAILABLE</div>
              ...
              <div className="includeBox">
                <div className="ngcontent-serverapp">
                  ...
                  <span className="blueTag graytxt">
                    Available from $250.68 /month
                  </span>
                </div>
              ...
              <div className="includeBox">
                ...
                <div className="detailRow">
                  ...
                  <span className="textSection">
                    Cloud to help you run your app is included in this price.
                    It’s topped up each month. Learn more
                  </span>
                </div>
              </div>
            </div>
